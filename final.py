...
speak_arabic("لإكتشاف الأشياء يرجى الضغط على الزر الأول , " \
"لقراءة النصوص يرجى الضغط على الزر الثاني" \
"  , لتسجيل عنصر شخصي يرجى الضغط على الزر الثالث" \
"  , لمعرفة الوقت الحالي يرجى الضغط على الزر الرابع")
# =====================================================
# Utils
# =====================================================
def is_arabic(text):
